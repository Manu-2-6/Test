...
Ce dépôt contient une application WPF (.NET 8) destinée à automatiser l'installation de logiciels essentiels (VLC, Google Chrome, Adobe Reader, etc.) sur un PC fraîchement installé sous Windows 11.
...
- **Problèmes de compilation XAML** → Vérifie que tu utilises bien .NET 8 et que tous les packages sont restaurés.
