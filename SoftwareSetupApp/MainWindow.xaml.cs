...
""";
    ...
    public MainWindow()
    {
        ...
        Packages.Add(new SoftwarePackage("Nvidia App", "NVIDIACorporation.NVIDIAApp"));
        Packages.Add(new SoftwarePackage("AMD Software Adrenalin", "AdvancedMicroDevicesInc.AMDSoftwareAdrenalinEdition"));
